...
export const ScrollSpyContent = ({ parentId, items, className = '' }: ScrollSpyContentProps) => {
  const activeIndex = useScrollSpy(parentId, items.length);

  return (
    <div className={`sticky top-0 w-full transition-opacity duration-300 ${className}`}>
