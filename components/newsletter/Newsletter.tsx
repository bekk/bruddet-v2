          ...
          >
            <DialogClose asChild>
              <button className="absolute top-0 right-0 h-8 w-8 mt-4 mr-4">
                <Image src={exitButton} alt={'Exitknapp for å lukke nyhetsbrevpåmeldingen'} />
              </button>
            </DialogClose>
            <DialogTitle className="text-lg text-center font-normal">
              Meld deg på nyhetsbrev fra ibruddet og få ekslusiv info, billetter til redusert pris
              og andre tilbud!
            </DialogTitle>
